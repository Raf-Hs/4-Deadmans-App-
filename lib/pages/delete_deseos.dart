...
class DeleteDeseos extends StatefulWidget {
  int IDProd,index;
 DeleteDeseos (this.IDProd, this.index, {super.key});


  @override
 State<DeleteDeseos> createState() => _DeleteDeseos();
...
class _DeleteDeseos extends State<DeleteDeseos> {
  ...
  Future <List <Datos_Productos>> obtenerProductos (int idprod,int idclie) async {
      ...
      var url= Uri.http("dtai.uteq.edu.mx","~rafher207/DAPPS/deleteDeseos.php");
      ...
      body: Center(
        ...
        child: Column ( children: [
          ...
          ElevatedButton(onPressed: (){
                ...
                Navigator.pushNamedAndRemoveUntil(context,"/Deseos",(Route <dynamic> route) => false);
          }, 
