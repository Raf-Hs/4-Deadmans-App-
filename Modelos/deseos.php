...
//Corregir en la bd
		$sql="SELECT productos.id_producto, nombre, precio,imagen  FROM  deseos AS deseos LEFT JOIN productos AS productos ON productos.id_producto=deseos.id_producto where id_cliente like '1';";
